...
OmxModule.prototype.registerListeners = function(callbacks, successCB, errorCB, objectRef)
{
    ...
    listeners.push(objectRef) > currentLength ? successCB("MediaPlay API registerListeners: " +  objectRef.from) : errorCB("MediaPlay API failed registerListeners");
...
OmxModule.prototype.unregisterListenersOnLeave = function(params, successCB, errorCB, objectRef){
    ...
    errorCB("MediaPlay: listener " + objectRef.from + "n ot found");
}
