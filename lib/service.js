...
(function() {
    ...
    var MediaApiModule = function(rpcHandler, params) {
        ...
        this.params = params;
        media_module.setRpcHandler(rpcHandler);
    };
    ...
    var Media = function(rpcHandler, params) {
        ...
        this.base({
            ...
            description: 'Webinos Media-Play API'
        });
    ...
    Media.prototype.registerListeners = function (callbacks, successCB, errorCB, objectRef)
    {
        "use strict";
        media_module.registerListeners(callbacks, successCB, errorCB, objectRef);
    }

    Media.prototype.unregisterListenersOnLeave = function (param, successCB, errorCB, objectRef)
    {
        "use strict";
        media_module.unregisterListenersOnLeave(successCB, errorCB, objectRef);
    }

    Media.prototype.unregisterListenersOnExit = function (param, successCB, errorCB, objectRef)
    {
        "use strict";
        media_module.unregisterListenersOnExit(objectRef);
    }
    ...
    {
        "use strict";
        media_module.setVolume(params, successCB, errorCB);
    }
    ...
    Media.prototype.isPlaying = function (params, successCB, errorCB)
    {
        "use strict";
        media_module.isPlaying(successCB, errorCB);
    }
