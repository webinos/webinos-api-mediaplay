...
(function(){
    ...
    MediaApiModule.prototype.init = function(register, unregister) 
    {
        ...
        if(process.platform === "linux"){            
            var mplayer_hash = exec("hash mplayer");
            mplayer_hash.on("close", function(exitCode){   
                if(exitCode === 0){
            ...
            var omxplayer_hash = exec("hash omxplayer");
            omxplayer_hash.on("close", function(exitCode){   
                if(exitCode === 0){
