    ...
    var Connection = (function () {
        ...
        Connection.prototype.send = function (data, callback) {
            ...
            if (!this.isActive()) {
                ...
                this.socket.write(data, function(){console.log("MediaPlay API successCB: written on json2rpc socket with no error");});
            }
        ...
        Connection.prototype.onError = function (evt) {
            console.log("MediaPlay API: XBMC connection error " + evt);
        };

        Connection.prototype.onClose = function (evt) {
            console.log("MediaPlay API: XBMC connection closed: " + evt);
        };
                ...
                try {
                    ...
                    for(var i=0;i<sanitizedBuffer.length;i++){
                        if(typeof sanitizedBuffer[i].method !== 'undefined')
                            console.log("MediaPlay API: received data on json2rpc socket from method " + sanitizedBuffer[i].method);                        
                    ...
                    console.log("MediaPlay API error while receiving data from json2rpc socket: " + err);
                }
            };
        }
        ...
        Connection.prototype.onEnd = function () {
            _this = this;
            return function() {
                console.log("MediaPlay API: json2rpc socket closed");
            };
        }
