...
this.setVolume = function(volume, successCB, errorCB)
{    
...
this.registerListeners = function(callbacks, successCB, errorCB, objectRef)
{        
...
this.unregisterListenersOnLeave = function(successCB, errorCB, objectRef){    
...
this.unregisterListenersOnExit = function(objectRef)
{       
    //indexOf does not work for complex objects
    for(var i=0;i<listeners.length;i++)
    {        
...
this.setRpcHandler = function(rpcHandler)
{
