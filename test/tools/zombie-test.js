...
*
* Copyright 2013 University of Oxford, ISMB
*******************************************************************************/
...
var totalPath = "http://localhost:8080/webinos-api-mediaplay/test/jasmine/Mediaplay.html";

console.log("Visiting: " + totalPath);

browser.visit(totalPath, function() {  
   browser.wait(6000, function() {
...
/*
browser.visit(totalPath).then(function(){
    var document = browser.document;
    var results = document.querySelector(".symbolSummary");
    console.log(results);
    var failed = results.querySelector(".failed");
